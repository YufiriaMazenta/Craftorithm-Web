...
export const deDe: Record<MessageKey, string> = {
  ...
  "picker.tagSummaryMore": "{items} und {count} insgesamt",
  "picker.tagWiki": "{name} im Wiki ansehen",
  ...
  /*
   * Umgangssprachliche Namen der Material-Tags. Der Schlüssel ist
   * tag.<unveränderter Tag-Name>, auch bei den Namen mit Schrägstrich
   * wie enchantable/armor.
   *
   * Hier steht nur, *was* der Tag ist, niemals welche Gegenstände er
   * enthält: die Mitgliederliste erzeugt die Auswahl selbst aus den
   * offiziellen Gegenstandsnamen, eine Wiederholung hier wäre doppelt
   * und würde mit jeder Version veralten.
   *
   * Tags mit identischem Inhalt lassen sich nur durch diesen Text
   * unterscheiden: planks und wooden_tool_materials enthalten beide
   * dieselben zwölf Bretterarten, nur der Name sagt, dass eines
   * Baumaterial und das andere Reparaturmaterial ist.
   */
  "tag.acacia_logs": "Akazienholz",
  "tag.anvil": "Ambosse",
  "tag.armadillo_food": "Gürteltierfutter",
  "tag.arrows": "Pfeile",
  "tag.axes": "Äxte",
  "tag.axolotl_food": "Axolotl-Futter",
  "tag.bamboo_blocks": "Bambusblöcke",
  "tag.banners": "Banner",
  "tag.bars": "Gitter",
  "tag.beacon_payment_items": "Leuchtfeuer-Bezahlung",
  "tag.beds": "Betten",
  "tag.bee_food": "Bienenfutter",
  "tag.birch_logs": "Birkenholz",
  "tag.boats": "Boote",
  "tag.book_cloning_target": "Kopierbare Bücher",
  "tag.bookshelf_books": "Bücherregal-Bücher",
  "tag.breaks_decorated_pots": "Zerbricht verzierte Krüge",
  "tag.brewing_fuel": "Braustand-Brennstoff",
  "tag.bundles": "Bündel",
  "tag.buttons": "Knöpfe",
  "tag.camel_food": "Dromedarfutter",
  "tag.camel_husk_food": "Zombiedromedar-Futter",
  "tag.candles": "Kerzen",
  "tag.cat_collar_dyes": "Katzenhalsband-Farbstoffe",
  "tag.cat_food": "Katzenfutter",
  "tag.cauldron_can_remove_dye": "Im Kessel entfärbbar",
  "tag.chains": "Ketten",
  "tag.cherry_logs": "Kirschholz",
  "tag.chest_armor": "Harnische",
  "tag.chest_boats": "Truhenboote",
  "tag.chicken_food": "Hühnerfutter",
  "tag.cluster_max_harvestables": "Volle Amethystbeute",
  "tag.coal_ores": "Steinkohle-Erze",
  "tag.coals": "Kohle und Holzkohle",
  "tag.compasses": "Kompasse",
  "tag.completes_find_tree_tutorial": "Baum-Tutorial-Stämme",
  "tag.concrete": "Beton",
  "tag.concrete_powders": "Trockenbeton",
  "tag.copper": "Kupferblöcke",
  "tag.copper_chests": "Kupfertruhen",
  "tag.copper_golem_statues": "Kupfergolemstatuen",
  "tag.copper_ores": "Kupfererze",
  "tag.copper_tool_materials": "Kupferwerkzeug-Material",
  "tag.cow_food": "Kuhfutter",
  "tag.creeper_drop_music_discs": "Creeper-Schallplatten",
  "tag.creeper_igniters": "Entzündet Creeper",
  "tag.crimson_stems": "Karmesinstiele",
  "tag.dampens_vibrations": "Dämpft Vibrationen",
  "tag.dark_oak_logs": "Schwarzeichenholz",
  "tag.decorated_pot_ingredients": "Krugzutaten",
  "tag.decorated_pot_sherds": "Töpferscherben",
  "tag.diamond_ores": "Diamanterze",
  "tag.diamond_tool_materials": "Diamantwerkzeug-Material",
  "tag.dirt": "Erdblöcke",
  "tag.doors": "Türen",
  "tag.drowned_preferred_weapons": "Ertrunkenen-Waffen",
  "tag.duplicates_allays": "Vervielfältigt Hilfsgeister",
  "tag.dyes": "Farbstoffe",
  "tag.eggs": "Eier",
  "tag.emerald_ores": "Smaragderze",
  "tag.enchantable/armor": "Verzauberbare Rüstung",
  "tag.enchantable/bow": "Verzauberbare Bögen",
  "tag.enchantable/chest_armor": "Verzauberbare Harnische",
  "tag.enchantable/crossbow": "Verzauberbare Armbrüste",
  "tag.enchantable/durability": "Nimmt Haltbarkeit",
  "tag.enchantable/equippable": "Verzauberbare Ausrüstung",
  "tag.enchantable/fire_aspect": "Nimmt Verbrennung",
  "tag.enchantable/fishing": "Verzauberbare Angeln",
  "tag.enchantable/foot_armor": "Verzauberbare Stiefel",
  "tag.enchantable/head_armor": "Verzauberbare Helme",
  "tag.enchantable/leg_armor": "Verzauberbarer Beinschutz",
  "tag.enchantable/lunge": "Nimmt Ausfallschritt",
  "tag.enchantable/mace": "Verzauberbare Streitkolben",
  "tag.enchantable/melee_weapon": "Nimmt Nahkampfverzauberungen",
  "tag.enchantable/mining": "Nimmt Abbauverzauberungen",
  "tag.enchantable/mining_loot": "Nimmt Glück",
  "tag.enchantable/sharp_weapon": "Nimmt Schärfe",
  "tag.enchantable/sweeping": "Nimmt Schwungkraft",
  "tag.enchantable/trident": "Verzauberbare Dreizacke",
  "tag.enchantable/vanishing": "Nimmt Fluch des Verschwindens",
  "tag.enchantable/weapon": "Nimmt Waffenverzauberungen",
  "tag.fence_gates": "Zauntore",
  "tag.fences": "Zäune",
  "tag.fishes": "Fische",
  "tag.flowers": "Blumen",
  "tag.foot_armor": "Stiefel",
  "tag.fox_food": "Fuchsfutter",
  "tag.freeze_immune_wearables": "Schützt vor Kälte",
  "tag.frog_food": "Froschfutter",
  "tag.furnace_minecart_fuel": "Antriebslore-Brennstoff",
  "tag.gaze_disguise_equipment": "Verbirgt deinen Blick",
  "tag.glazed_terracotta": "Glasierte Keramik",
  "tag.goat_food": "Ziegenfutter",
  "tag.gold_ores": "Golderze",
  "tag.gold_tool_materials": "Goldwerkzeug-Material",
  "tag.grass_blocks": "Grasblöcke",
  "tag.hanging_signs": "Hängeschilder",
  "tag.happy_ghast_food": "Futter glücklicher Ghasts",
  "tag.happy_ghast_tempt_items": "Lockt glückliche Ghasts",
  "tag.harnesses": "Geschirre",
  "tag.head_armor": "Helme",
  "tag.hoes": "Hacken",
  "tag.hoglin_food": "Hoglinfutter",
  "tag.horse_food": "Pferdefutter",
  "tag.horse_tempt_items": "Lockt Pferde",
  "tag.ignored_by_piglin_babies": "Junge Piglins ignorieren es",
  "tag.iron_ores": "Eisenerze",
  "tag.iron_tool_materials": "Eisenwerkzeug-Material",
  "tag.jungle_logs": "Tropenholz",
  "tag.lanterns": "Laternen",
  "tag.lapis_ores": "Lapislazulierze",
  "tag.leaves": "Laub",
  "tag.lectern_books": "Lesepult-Bücher",
  "tag.leg_armor": "Beinschutz",
  "tag.lightning_rods": "Blitzableiter",
  "tag.llama_food": "Lamafutter",
  "tag.llama_tempt_items": "Lockt Lamas",
  "tag.logs": "Stämme und Hölzer",
  "tag.logs_that_burn": "Brennbare Stämme",
  "tag.loom_dyes": "Webstuhl-Farbstoffe",
  "tag.loom_patterns": "Webstuhl-Vorlagen",
  "tag.mangrove_logs": "Mangrovenholz",
  "tag.map_invisibility_equipment": "Verbirgt Kartenmarkierung",
  "tag.meat": "Fleisch",
  "tag.metal_nuggets": "Metallklumpen",
  "tag.moss_blocks": "Moosblöcke",
  "tag.mud": "Schlammblöcke",
  "tag.nautilus_bucket_food": "Nautilus-Fischeimer",
  "tag.nautilus_food": "Nautilusfutter",
  "tag.nautilus_taming_items": "Zähmt Nautilusse",
  "tag.netherite_tool_materials": "Netheritwerkzeug-Material",
  "tag.non_flammable_wood": "Nicht brennbares Holz",
  "tag.noteblock_top_instruments": "Notenblock-Köpfe",
  "tag.oak_logs": "Eichenholz",
  "tag.ocelot_food": "Ozelotfutter",
  "tag.pale_oak_logs": "Blasseichenholz",
  "tag.panda_eats_from_ground": "Pandas heben es auf",
  "tag.panda_food": "Pandafutter",
  "tag.parrot_food": "Papageienfutter",
  "tag.parrot_poisonous_food": "Vergiftet Papageien",
  "tag.pickaxes": "Spitzhacken",
  "tag.pig_food": "Schweinefutter",
  "tag.piglin_food": "Piglins essen es",
  "tag.piglin_loved": "Piglins lieben es",
  "tag.piglin_preferred_weapons": "Piglin-Waffen",
  "tag.piglin_repellents": "Vertreibt Piglins",
  "tag.piglin_safe_armor": "Piglinsichere Rüstung",
  "tag.pillager_preferred_weapons": "Plünderer-Waffen",
  "tag.planks": "Bretter",
  "tag.rabbit_food": "Kaninchenfutter",
  "tag.rails": "Schienen",
  "tag.redstone_ores": "Redstone-Erze",
  "tag.repairs_chain_armor": "Repariert Kettenrüstung",
  "tag.repairs_copper_armor": "Repariert Kupferrüstung",
  "tag.repairs_diamond_armor": "Repariert Diamantrüstung",
  "tag.repairs_gold_armor": "Repariert Goldrüstung",
  "tag.repairs_iron_armor": "Repariert Eisenrüstung",
  "tag.repairs_leather_armor": "Repariert Lederrüstung",
  "tag.repairs_netherite_armor": "Repariert Netheritrüstung",
  "tag.repairs_turtle_helmet": "Repariert Schildkrötenpanzer",
  "tag.repairs_wolf_armor": "Repariert Wolfspanzer",
  "tag.sand": "Sand",
  "tag.saplings": "Setzlinge",
  "tag.shearable_from_copper_golem": "Vom Kupfergolem abscherbar",
  "tag.sheep_food": "Schaffutter",
  "tag.shovels": "Schaufeln",
  "tag.shulker_boxes": "Shulker-Kisten",
  "tag.signs": "Schilder",
  "tag.skeleton_preferred_weapons": "Skelett-Waffen",
  "tag.skulls": "Köpfe und Schädel",
  "tag.slabs": "Stufen",
  "tag.small_flowers": "Kleine Blumen",
  "tag.smelts_to_glass": "Schmilzt zu Glas",
  "tag.sniffer_food": "Schnüfflerfutter",
  "tag.soul_fire_base_blocks": "Seelenfeuer-Untergrund",
  "tag.spears": "Speere",
  "tag.spruce_logs": "Fichtenholz",
  "tag.stairs": "Treppen",
  "tag.stone_bricks": "Steinziegel",
  "tag.stone_buttons": "Steinknöpfe",
  "tag.stone_crafting_materials": "Bruchstein zum Herstellen",
  "tag.stone_tool_materials": "Steinwerkzeug-Material",
  "tag.strider_food": "Schreiterfutter",
  "tag.strider_tempt_items": "Lockt Schreiter",
  "tag.sulfur_cube_archetype/bouncy": "Schwefelwürfel: federnd",
  "tag.sulfur_cube_archetype/explosive": "Schwefelwürfel: explosiv",
  "tag.sulfur_cube_archetype/fast_flat": "Schwefelwürfel: schnell flach",
  "tag.sulfur_cube_archetype/fast_sliding": "Schwefelwürfel: schnell gleitend",
  "tag.sulfur_cube_archetype/high_resistance": "Schwefelwürfel: widerstandsfähig",
  "tag.sulfur_cube_archetype/hot": "Schwefelwürfel: heiß",
  "tag.sulfur_cube_archetype/light": "Schwefelwürfel: leicht",
  "tag.sulfur_cube_archetype/regular": "Schwefelwürfel: normal",
  "tag.sulfur_cube_archetype/slow_bouncy": "Schwefelwürfel: träge federnd",
  "tag.sulfur_cube_archetype/slow_flat": "Schwefelwürfel: träge flach",
  "tag.sulfur_cube_archetype/slow_sliding": "Schwefelwürfel: träge gleitend",
  "tag.sulfur_cube_archetype/sticky": "Schwefelwürfel: klebrig",
  "tag.sulfur_cube_food": "Futter kleiner Schwefelwürfel",
  "tag.sulfur_cube_swallowable": "Schwefelwürfel verschlucken es",
  "tag.swords": "Schwerter",
  "tag.terracotta": "Keramik",
  "tag.trapdoors": "Falltüren",
  "tag.trim_materials": "Verzierungsmaterial",
  "tag.trimmable_armor": "Verzierbare Rüstung",
  "tag.turtle_food": "Schildkrötenfutter",
  "tag.villager_picks_up": "Dorfbewohner heben es auf",
  "tag.villager_plantable_seeds": "Dorfbewohner pflanzen es",
  "tag.walls": "Mauern",
  "tag.warped_stems": "Wirrstiele",
  "tag.wart_blocks": "Warzenblöcke",
  "tag.wither_skeleton_disliked_weapons": "Wither-Skelette meiden es",
  "tag.wolf_collar_dyes": "Wolfshalsband-Farbstoffe",
  "tag.wolf_food": "Wolfsfutter",
  "tag.wooden_buttons": "Holzknöpfe",
  "tag.wooden_doors": "Holztüren",
  "tag.wooden_fences": "Holzzäune",
  "tag.wooden_pressure_plates": "Holzdruckplatten",
  "tag.wooden_shelves": "Holzregale",
  "tag.wooden_slabs": "Holzstufen",
  "tag.wooden_stairs": "Holztreppen",
  "tag.wooden_tool_materials": "Holzwerkzeug-Material",
  "tag.wooden_trapdoors": "Holzfalltüren",
  "tag.wool": "Wolle",
  "tag.wool_carpets": "Teppiche",
  "tag.zombie_horse_food": "Zombiepferd-Futter",
