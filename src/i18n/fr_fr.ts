...
export const frFr: Record<MessageKey, string> = {
  ...
  "picker.tagSummaryMore": "{items} et {count} au total",
  "picker.tagWiki": "Voir {name} sur le wiki",
  ...
  /*
   * Noms en langage courant des tags de matériaux. La clé est
   * tag.<nom du tag tel quel>, y compris ceux qui contiennent une
   * barre oblique comme enchantable/armor.
   *
   * Ces libellés disent ce *qu'est* le tag, jamais quels objets il
   * contient : le sélecteur génère la liste des membres à partir des
   * noms officiels, la répéter ici serait redondant et vieillirait mal.
   *
   * Seul ce texte distingue les tags de contenu identique : planks et
   * wooden_tool_materials donnent les douze mêmes planches, l'un est
   * un matériau de construction, l'autre un matériau de réparation.
   */
  "tag.acacia_logs": "Bois d'acacia",
  "tag.anvil": "Enclumes",
  "tag.armadillo_food": "Nourriture de tatou",
  "tag.arrows": "Flèches",
  "tag.axes": "Haches",
  "tag.axolotl_food": "Nourriture d'axolotl",
  "tag.bamboo_blocks": "Blocs de bambou",
  "tag.banners": "Bannières",
  "tag.bars": "Barreaux",
  "tag.beacon_payment_items": "Paiement de la balise",
  "tag.beds": "Lits",
  "tag.bee_food": "Nourriture d'abeille",
  "tag.birch_logs": "Bois de bouleau",
  "tag.boats": "Bateaux",
  "tag.book_cloning_target": "Livres copiables",
  "tag.bookshelf_books": "Livres de bibliothèque",
  "tag.breaks_decorated_pots": "Fissure les vases",
  "tag.brewing_fuel": "Combustible de l'alambic",
  "tag.bundles": "Sacs",
  "tag.buttons": "Boutons",
  "tag.camel_food": "Nourriture de dromadaire",
  "tag.camel_husk_food": "Nourriture de dromadaire momifié",
  "tag.candles": "Bougies",
  "tag.cat_collar_dyes": "Teintures de collier de chat",
  "tag.cat_food": "Nourriture de chat",
  "tag.cauldron_can_remove_dye": "Cuir décolorable",
  "tag.chains": "Chaînes",
  "tag.cherry_logs": "Bois de cerisier",
  "tag.chest_armor": "Plastrons",
  "tag.chest_boats": "Bateaux de stockage",
  "tag.chicken_food": "Nourriture de poule",
  "tag.cluster_max_harvestables": "Améthyste complète",
  "tag.coal_ores": "Minerais de charbon",
  "tag.coals": "Charbon et charbon de bois",
  "tag.compasses": "Boussoles",
  "tag.completes_find_tree_tutorial": "Tutoriel de l'arbre",
  "tag.concrete": "Béton",
  "tag.concrete_powders": "Béton en poudre",
  "tag.copper": "Blocs de cuivre",
  "tag.copper_chests": "Coffres en cuivre",
  "tag.copper_golem_statues": "Statues de golem",
  "tag.copper_ores": "Minerais de cuivre",
  "tag.copper_tool_materials": "Matériau en cuivre",
  "tag.cow_food": "Nourriture de vache",
  "tag.creeper_drop_music_discs": "Disques des creepers",
  "tag.creeper_igniters": "Enflamme les creepers",
  "tag.crimson_stems": "Tiges carmin",
  "tag.dampens_vibrations": "Atténue les vibrations",
  "tag.dark_oak_logs": "Bois de chêne noir",
  "tag.decorated_pot_ingredients": "Parties de vase décoré",
  "tag.decorated_pot_sherds": "Tessons de poterie",
  "tag.diamond_ores": "Minerais de diamant",
  "tag.diamond_tool_materials": "Matériau en diamant",
  "tag.dirt": "Blocs de terre",
  "tag.doors": "Portes",
  "tag.drowned_preferred_weapons": "Armes des noyés",
  "tag.duplicates_allays": "Duplique les allays",
  "tag.dyes": "Teintures",
  "tag.eggs": "Oeufs",
  "tag.emerald_ores": "Minerais d'émeraude",
  "tag.enchantable/armor": "Armures enchantables",
  "tag.enchantable/bow": "Arcs enchantables",
  "tag.enchantable/chest_armor": "Plastrons enchantables",
  "tag.enchantable/crossbow": "Arbalètes enchantables",
  "tag.enchantable/durability": "Enchantable : Solidité",
  "tag.enchantable/equippable": "Équipement enchantable",
  "tag.enchantable/fire_aspect": "Enchantable : Aura de feu",
  "tag.enchantable/fishing": "Cannes enchantables",
  "tag.enchantable/foot_armor": "Bottes enchantables",
  "tag.enchantable/head_armor": "Casques enchantables",
  "tag.enchantable/leg_armor": "Jambières enchantables",
  "tag.enchantable/lunge": "Enchantable : Élan",
  "tag.enchantable/mace": "Masses enchantables",
  "tag.enchantable/melee_weapon": "Enchantable : corps à corps",
  "tag.enchantable/mining": "Enchantable : minage",
  "tag.enchantable/mining_loot": "Enchantable : Fortune",
  "tag.enchantable/sharp_weapon": "Enchantable : Tranchant",
  "tag.enchantable/sweeping": "Enchantable : Affilage",
  "tag.enchantable/trident": "Tridents enchantables",
  "tag.enchantable/vanishing": "Enchantable : disparition",
  "tag.enchantable/weapon": "Enchantable : arme",
  "tag.fence_gates": "Portillons",
  "tag.fences": "Barrières",
  "tag.fishes": "Poissons",
  "tag.flowers": "Fleurs",
  "tag.foot_armor": "Bottes",
  "tag.fox_food": "Nourriture de renard",
  "tag.freeze_immune_wearables": "Protège du gel",
  "tag.frog_food": "Nourriture de grenouille",
  "tag.furnace_minecart_fuel": "Combustible du wagonnet",
  "tag.gaze_disguise_equipment": "Cache votre regard",
  "tag.glazed_terracotta": "Terre cuite émaillée",
  "tag.goat_food": "Nourriture de chèvre",
  "tag.gold_ores": "Minerais d'or",
  "tag.gold_tool_materials": "Matériau en or",
  "tag.grass_blocks": "Blocs d'herbe",
  "tag.hanging_signs": "Pancartes suspendues",
  "tag.happy_ghast_food": "Nourriture de ghast joyeux",
  "tag.happy_ghast_tempt_items": "Appât pour ghast joyeux",
  "tag.harnesses": "Harnais",
  "tag.head_armor": "Casques",
  "tag.hoes": "Houes",
  "tag.hoglin_food": "Nourriture de hoglin",
  "tag.horse_food": "Nourriture de cheval",
  "tag.horse_tempt_items": "Appât pour cheval",
  "tag.ignored_by_piglin_babies": "Ignoré par les bébés piglins",
  "tag.iron_ores": "Minerais de fer",
  "tag.iron_tool_materials": "Matériau en fer",
  "tag.jungle_logs": "Bois d'acajou",
  "tag.lanterns": "Lanternes",
  "tag.lapis_ores": "Minerais de lapis-lazuli",
  "tag.leaves": "Feuilles",
  "tag.lectern_books": "Livres de pupitre",
  "tag.leg_armor": "Jambières",
  "tag.lightning_rods": "Paratonnerres",
  "tag.llama_food": "Nourriture de lama",
  "tag.llama_tempt_items": "Appât pour lama",
  "tag.logs": "Bûches et bois",
  "tag.logs_that_burn": "Bois inflammable",
  "tag.loom_dyes": "Teintures du métier",
  "tag.loom_patterns": "Motifs du métier",
  "tag.mangrove_logs": "Bois de palétuvier",
  "tag.map_invisibility_equipment": "Cache votre marqueur",
  "tag.meat": "Viandes",
  "tag.metal_nuggets": "Pépites de métal",
  "tag.moss_blocks": "Blocs de mousse",
  "tag.mud": "Blocs de boue",
  "tag.nautilus_bucket_food": "Poissons en seau pour nautile",
  "tag.nautilus_food": "Nourriture de nautile",
  "tag.nautilus_taming_items": "Apprivoise le nautile",
  "tag.netherite_tool_materials": "Matériau en Netherite",
  "tag.non_flammable_wood": "Bois ininflammable",
  "tag.noteblock_top_instruments": "Têtes du bloc musical",
  "tag.oak_logs": "Bois de chêne",
  "tag.ocelot_food": "Nourriture d'ocelot",
  "tag.pale_oak_logs": "Bois de chêne pâle",
  "tag.panda_eats_from_ground": "Ramassé par les pandas",
  "tag.panda_food": "Nourriture de panda",
  "tag.parrot_food": "Nourriture de perroquet",
  "tag.parrot_poisonous_food": "Poison de perroquet",
  "tag.pickaxes": "Pioches",
  "tag.pig_food": "Nourriture de cochon",
  "tag.piglin_food": "Nourriture de piglin",
  "tag.piglin_loved": "Adoré des piglins",
  "tag.piglin_preferred_weapons": "Armes des piglins",
  "tag.piglin_repellents": "Repousse les piglins",
  "tag.piglin_safe_armor": "Armure en or tolérée",
  "tag.pillager_preferred_weapons": "Armes des pillards",
  "tag.planks": "Planches",
  "tag.rabbit_food": "Nourriture de lapin",
  "tag.rails": "Rails",
  "tag.redstone_ores": "Minerais de redstone",
  "tag.repairs_chain_armor": "Répare la cotte de mailles",
  "tag.repairs_copper_armor": "Répare l'armure en cuivre",
  "tag.repairs_diamond_armor": "Répare l'armure en diamant",
  "tag.repairs_gold_armor": "Répare l'armure en or",
  "tag.repairs_iron_armor": "Répare l'armure en fer",
  "tag.repairs_leather_armor": "Répare l'armure en cuir",
  "tag.repairs_netherite_armor": "Répare l'armure en Netherite",
  "tag.repairs_turtle_helmet": "Répare la carapace",
  "tag.repairs_wolf_armor": "Répare l'armure de loup",
  "tag.sand": "Sables",
  "tag.saplings": "Pousses",
  "tag.shearable_from_copper_golem": "Tondu sur golem de cuivre",
  "tag.sheep_food": "Nourriture de mouton",
  "tag.shovels": "Pelles",
  "tag.shulker_boxes": "Boîtes de Shulker",
  "tag.signs": "Pancartes",
  "tag.skeleton_preferred_weapons": "Armes des squelettes",
  "tag.skulls": "Têtes et crânes",
  "tag.slabs": "Dalles",
  "tag.small_flowers": "Petites fleurs",
  "tag.smelts_to_glass": "Se cuit en verre",
  "tag.sniffer_food": "Nourriture de renifleur",
  "tag.soul_fire_base_blocks": "Support du feu des âmes",
  "tag.spears": "Lances",
  "tag.spruce_logs": "Bois de sapin",
  "tag.stairs": "Escaliers",
  "tag.stone_bricks": "Pierres taillées",
  "tag.stone_buttons": "Boutons en pierre",
  "tag.stone_crafting_materials": "Pierres de fabrication",
  "tag.stone_tool_materials": "Matériau en pierre",
  "tag.strider_food": "Nourriture d'arpenteur",
  "tag.strider_tempt_items": "Appât pour arpenteur",
  "tag.sulfur_cube_archetype/bouncy": "Cube de soufre : élastique",
  "tag.sulfur_cube_archetype/explosive": "Cube de soufre : explosif",
  "tag.sulfur_cube_archetype/fast_flat": "Cube de soufre : vif plat",
  "tag.sulfur_cube_archetype/fast_sliding": "Cube de soufre : vif glissant",
  "tag.sulfur_cube_archetype/high_resistance": "Cube de soufre : très résistant",
  "tag.sulfur_cube_archetype/hot": "Cube de soufre : brûlant",
  "tag.sulfur_cube_archetype/light": "Cube de soufre : léger",
  "tag.sulfur_cube_archetype/regular": "Cube de soufre : normal",
  "tag.sulfur_cube_archetype/slow_bouncy": "Cube de soufre : lent élastique",
  "tag.sulfur_cube_archetype/slow_flat": "Cube de soufre : lent plat",
  "tag.sulfur_cube_archetype/slow_sliding": "Cube de soufre : lent glissant",
  "tag.sulfur_cube_archetype/sticky": "Cube de soufre : collant",
  "tag.sulfur_cube_food": "Nourriture de cube de soufre",
  "tag.sulfur_cube_swallowable": "Avalable par le cube de soufre",
  "tag.swords": "Épées",
  "tag.terracotta": "Terre cuite",
  "tag.trapdoors": "Trappes",
  "tag.trim_materials": "Matériaux d'ornement",
  "tag.trimmable_armor": "Armure ornementable",
  "tag.turtle_food": "Nourriture de tortue",
  "tag.villager_picks_up": "Ramassé par les villageois",
  "tag.villager_plantable_seeds": "Planté par les villageois",
  "tag.walls": "Murets",
  "tag.warped_stems": "Tiges biscornues",
  "tag.wart_blocks": "Blocs de verrues",
  "tag.wither_skeleton_disliked_weapons": "Évité des wither squelettes",
  "tag.wolf_collar_dyes": "Teintures de collier de loup",
  "tag.wolf_food": "Nourriture de loup",
  "tag.wooden_buttons": "Boutons en bois",
  "tag.wooden_doors": "Portes en bois",
  "tag.wooden_fences": "Barrières en bois",
  "tag.wooden_pressure_plates": "Plaques de pression en bois",
  "tag.wooden_shelves": "Étagères en bois",
  "tag.wooden_slabs": "Dalles en bois",
  "tag.wooden_stairs": "Escaliers en bois",
  "tag.wooden_tool_materials": "Matériau en bois",
  "tag.wooden_trapdoors": "Trappes en bois",
  "tag.wool": "Laine",
  "tag.wool_carpets": "Tapis",
  "tag.zombie_horse_food": "Nourriture de cheval-zombie",
