...
export const ptBr: Record<MessageKey, string> = {
  ...
  "picker.tagSummaryMore": "{items} e {count} no total",
  "picker.tagWiki": "Ver {name} na wiki",
  ...
  /*
   * Nomes em linguagem simples das etiquetas de materiais; a chave é
   * tag.<nome original>, incluindo as que têm barra como enchantable/armor.
   *
   * Elas dizem o que a etiqueta *é*, nunca quais itens ela contém: o seletor
   * gera a lista de membros com os nomes oficiais, então repeti-la aqui
   * duplicaria o texto e ficaria desatualizada a cada versão.
   *
   * Etiquetas com o mesmo conteúdo só se distinguem por este texto:
   * planks e wooden_tool_materials contêm as mesmas 12 tábuas.
   */
  "tag.acacia_logs": "Madeira de acácia",
  "tag.anvil": "Bigornas",
  "tag.armadillo_food": "Comida de tatu",
  "tag.arrows": "Flechas",
  "tag.axes": "Machados",
  "tag.axolotl_food": "Comida de axolote",
  "tag.bamboo_blocks": "Blocos de bambu",
  "tag.banners": "Estandartes",
  "tag.bars": "Barras",
  "tag.beacon_payment_items": "Pagamento do sinalizador",
  "tag.beds": "Camas",
  "tag.bee_food": "Comida de abelha",
  "tag.birch_logs": "Madeira de bétula",
  "tag.boats": "Botes",
  "tag.book_cloning_target": "Livros copiáveis",
  "tag.bookshelf_books": "Livros do porta-livros",
  "tag.breaks_decorated_pots": "Racha vasos",
  "tag.brewing_fuel": "Combustível de poções",
  "tag.bundles": "Trouxas",
  "tag.buttons": "Botões",
  "tag.camel_food": "Comida de camelo",
  "tag.camel_husk_food": "Comida de camelo-múmia",
  "tag.candles": "Velas",
  "tag.cat_collar_dyes": "Corantes de coleira de gato",
  "tag.cat_food": "Comida de gato",
  "tag.cauldron_can_remove_dye": "Caldeirão remove corante",
  "tag.chains": "Correntes",
  "tag.cherry_logs": "Madeira de cerejeira",
  "tag.chest_armor": "Peitorais",
  "tag.chest_boats": "Botes com baú",
  "tag.chicken_food": "Comida de galinha",
  "tag.cluster_max_harvestables": "Ametista completa",
  "tag.coal_ores": "Minérios de carvão",
  "tag.coals": "Carvão e carvão vegetal",
  "tag.compasses": "Bússolas",
  "tag.completes_find_tree_tutorial": "Tutorial da árvore",
  "tag.concrete": "Concreto",
  "tag.concrete_powders": "Cimento",
  "tag.copper": "Blocos de cobre",
  "tag.copper_chests": "Baús de cobre",
  "tag.copper_golem_statues": "Estátuas de golem",
  "tag.copper_ores": "Minérios de cobre",
  "tag.copper_tool_materials": "Material de cobre",
  "tag.cow_food": "Comida de vaca",
  "tag.creeper_drop_music_discs": "Discos de creeper",
  "tag.creeper_igniters": "Acende creepers",
  "tag.crimson_stems": "Caules carmesim",
  "tag.dampens_vibrations": "Amortece vibrações",
  "tag.dark_oak_logs": "Madeira de carvalho escuro",
  "tag.decorated_pot_ingredients": "Partes de vaso",
  "tag.decorated_pot_sherds": "Óstracos de cerâmica",
  "tag.diamond_ores": "Minérios de diamante",
  "tag.diamond_tool_materials": "Material de diamante",
  "tag.dirt": "Blocos de terra",
  "tag.doors": "Portas",
  "tag.drowned_preferred_weapons": "Armas de afogado",
  "tag.duplicates_allays": "Duplica allays",
  "tag.dyes": "Corantes",
  "tag.eggs": "Ovos",
  "tag.emerald_ores": "Minérios de esmeralda",
  "tag.enchantable/armor": "Armaduras encantáveis",
  "tag.enchantable/bow": "Arcos encantáveis",
  "tag.enchantable/chest_armor": "Peitorais encantáveis",
  "tag.enchantable/crossbow": "Bestas encantáveis",
  "tag.enchantable/durability": "Encantável: Durabilidade",
  "tag.enchantable/equippable": "Equipamento encantável",
  "tag.enchantable/fire_aspect": "Encantável: Aspecto Flamejante",
  "tag.enchantable/fishing": "Varas encantáveis",
  "tag.enchantable/foot_armor": "Botas encantáveis",
  "tag.enchantable/head_armor": "Capacetes encantáveis",
  "tag.enchantable/leg_armor": "Calças encantáveis",
  "tag.enchantable/lunge": "Encantável: Estocada",
  "tag.enchantable/mace": "Maças encantáveis",
  "tag.enchantable/melee_weapon": "Encantável: corpo a corpo",
  "tag.enchantable/mining": "Encantável: mineração",
  "tag.enchantable/mining_loot": "Encantável: saque mineral",
  "tag.enchantable/sharp_weapon": "Encantável: Afiação",
  "tag.enchantable/sweeping": "Encantável: Alcance",
  "tag.enchantable/trident": "Tridentes encantáveis",
  "tag.enchantable/vanishing": "Encantável: Desaparecimento",
  "tag.enchantable/weapon": "Encantável: arma",
  "tag.fence_gates": "Portões",
  "tag.fences": "Cercas",
  "tag.fishes": "Peixes",
  "tag.flowers": "Flores",
  "tag.foot_armor": "Botas",
  "tag.fox_food": "Comida de raposa",
  "tag.freeze_immune_wearables": "Evita congelamento",
  "tag.frog_food": "Comida de sapo",
  "tag.furnace_minecart_fuel": "Combustível do carrinho",
  "tag.gaze_disguise_equipment": "Esconde seu olhar",
  "tag.glazed_terracotta": "Azulejos",
  "tag.goat_food": "Comida de cabra",
  "tag.gold_ores": "Minérios de ouro",
  "tag.gold_tool_materials": "Material de ouro",
  "tag.grass_blocks": "Blocos de grama",
  "tag.hanging_signs": "Placas suspensas",
  "tag.happy_ghast_food": "Comida de ghast feliz",
  "tag.happy_ghast_tempt_items": "Isca de ghast feliz",
  "tag.harnesses": "Arreios",
  "tag.head_armor": "Capacetes",
  "tag.hoes": "Enxadas",
  "tag.hoglin_food": "Comida de hoglin",
  "tag.horse_food": "Comida de cavalo",
  "tag.horse_tempt_items": "Isca de cavalo",
  "tag.ignored_by_piglin_babies": "Piglins bebês ignoram",
  "tag.iron_ores": "Minérios de ferro",
  "tag.iron_tool_materials": "Material de ferro",
  "tag.jungle_logs": "Madeira da selva",
  "tag.lanterns": "Lampiões",
  "tag.lapis_ores": "Minérios de lápis-lazúli",
  "tag.leaves": "Folhas",
  "tag.lectern_books": "Livros do atril",
  "tag.leg_armor": "Calças",
  "tag.lightning_rods": "Para-raios",
  "tag.llama_food": "Comida de lhama",
  "tag.llama_tempt_items": "Isca de lhama",
  "tag.logs": "Troncos e madeiras",
  "tag.logs_that_burn": "Madeiras inflamáveis",
  "tag.loom_dyes": "Corantes do tear",
  "tag.loom_patterns": "Figuras do tear",
  "tag.mangrove_logs": "Madeira de mangue",
  "tag.map_invisibility_equipment": "Esconde sua marca",
  "tag.meat": "Carne",
  "tag.metal_nuggets": "Pepitas de metal",
  "tag.moss_blocks": "Blocos de musgo",
  "tag.mud": "Blocos de barro",
  "tag.nautilus_bucket_food": "Peixes em balde para náutilo",
  "tag.nautilus_food": "Comida de náutilo",
  "tag.nautilus_taming_items": "Doma náutilos",
  "tag.netherite_tool_materials": "Material de netherita",
  "tag.non_flammable_wood": "Madeira não inflamável",
  "tag.noteblock_top_instruments": "Cabeças do bloco musical",
  "tag.oak_logs": "Madeira de carvalho",
  "tag.ocelot_food": "Comida de jaguatirica",
  "tag.pale_oak_logs": "Madeira de carvalho pálido",
  "tag.panda_eats_from_ground": "Pandas pegam do chão",
  "tag.panda_food": "Comida de panda",
  "tag.parrot_food": "Comida de papagaio",
  "tag.parrot_poisonous_food": "Envenena papagaios",
  "tag.pickaxes": "Picaretas",
  "tag.pig_food": "Comida de porco",
  "tag.piglin_food": "Comida de piglin",
  "tag.piglin_loved": "Piglins adoram",
  "tag.piglin_preferred_weapons": "Armas de piglin",
  "tag.piglin_repellents": "Espanta piglins",
  "tag.piglin_safe_armor": "Piglins toleram",
  "tag.pillager_preferred_weapons": "Armas de saqueador",
  "tag.planks": "Tábuas",
  "tag.rabbit_food": "Comida de coelho",
  "tag.rails": "Trilhos",
  "tag.redstone_ores": "Minérios de redstone",
  "tag.repairs_chain_armor": "Repara malha",
  "tag.repairs_copper_armor": "Repara armadura de cobre",
  "tag.repairs_diamond_armor": "Repara armadura de diamante",
  "tag.repairs_gold_armor": "Repara armadura de ouro",
  "tag.repairs_iron_armor": "Repara armadura de ferro",
  "tag.repairs_leather_armor": "Repara armadura de couro",
  "tag.repairs_netherite_armor": "Repara armadura de netherita",
  "tag.repairs_turtle_helmet": "Repara casco de tartaruga",
  "tag.repairs_wolf_armor": "Repara armadura de lobo",
  "tag.sand": "Areia",
  "tag.saplings": "Mudas",
  "tag.shearable_from_copper_golem": "Tosquiado do golem",
  "tag.sheep_food": "Comida de ovelha",
  "tag.shovels": "Pás",
  "tag.shulker_boxes": "Caixas de shulker",
  "tag.signs": "Placas",
  "tag.skeleton_preferred_weapons": "Armas de esqueleto",
  "tag.skulls": "Cabeças e crânios",
  "tag.slabs": "Lajes",
  "tag.small_flowers": "Flores pequenas",
  "tag.smelts_to_glass": "Funde em vidro",
  "tag.sniffer_food": "Comida de farejador",
  "tag.soul_fire_base_blocks": "Base do fogo das almas",
  "tag.spears": "Lanças",
  "tag.spruce_logs": "Madeira de abeto",
  "tag.stairs": "Escadas",
  "tag.stone_bricks": "Tijolos de pedra",
  "tag.stone_buttons": "Botões de pedra",
  "tag.stone_crafting_materials": "Pedras de fabricação",
  "tag.stone_tool_materials": "Material de pedra",
  "tag.strider_food": "Comida de lavagante",
  "tag.strider_tempt_items": "Isca de lavagante",
  "tag.sulfur_cube_archetype/bouncy": "Cubo de enxofre: elástico",
  "tag.sulfur_cube_archetype/explosive": "Cubo de enxofre: explosivo",
  "tag.sulfur_cube_archetype/fast_flat": "Cubo de enxofre: rápido plano",
  "tag.sulfur_cube_archetype/fast_sliding": "Cubo de enxofre: rápido deslizante",
  "tag.sulfur_cube_archetype/high_resistance": "Cubo de enxofre: muito resistente",
  "tag.sulfur_cube_archetype/hot": "Cubo de enxofre: quente",
  "tag.sulfur_cube_archetype/light": "Cubo de enxofre: leve",
  "tag.sulfur_cube_archetype/regular": "Cubo de enxofre: normal",
  "tag.sulfur_cube_archetype/slow_bouncy": "Cubo de enxofre: lento elástico",
  "tag.sulfur_cube_archetype/slow_flat": "Cubo de enxofre: lento plano",
  "tag.sulfur_cube_archetype/slow_sliding": "Cubo de enxofre: lento deslizante",
  "tag.sulfur_cube_archetype/sticky": "Cubo de enxofre: grudento",
  "tag.sulfur_cube_food": "Comida de cubo de enxofre",
  "tag.sulfur_cube_swallowable": "Cubos de enxofre engolem",
  "tag.swords": "Espadas",
  "tag.terracotta": "Terracota",
  "tag.trapdoors": "Alçapões",
  "tag.trim_materials": "Material de enfeites",
  "tag.trimmable_armor": "Aceita enfeites",
  "tag.turtle_food": "Comida de tartaruga",
  "tag.villager_picks_up": "Aldeões pegam do chão",
  "tag.villager_plantable_seeds": "Aldeões plantam",
  "tag.walls": "Muros",
  "tag.warped_stems": "Caules distorcidos",
  "tag.wart_blocks": "Blocos de fungos",
  "tag.wither_skeleton_disliked_weapons": "Esqueletos Wither evitam",
  "tag.wolf_collar_dyes": "Corantes de coleira de lobo",
  "tag.wolf_food": "Comida de lobo",
  "tag.wooden_buttons": "Botões de madeira",
  "tag.wooden_doors": "Portas de madeira",
  "tag.wooden_fences": "Cercas de madeira",
  "tag.wooden_pressure_plates": "Placas de pressão de madeira",
  "tag.wooden_shelves": "Estantes de madeira",
  "tag.wooden_slabs": "Lajes de madeira",
  "tag.wooden_stairs": "Escadas de madeira",
  "tag.wooden_tool_materials": "Material de madeira",
  "tag.wooden_trapdoors": "Alçapões de madeira",
  "tag.wool": "Lã",
  "tag.wool_carpets": "Tapetes",
  "tag.zombie_horse_food": "Comida de cavalo-zumbi",
