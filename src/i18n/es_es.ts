...
export const esEs: Record<MessageKey, string> = {
  ...
  "picker.tagSummaryMore": "{items} y {count} en total",
  "picker.tagWiki": "Ver {name} en la wiki",
  ...
  /*
   * Nombres en lenguaje llano de las etiquetas de materiales; la clave es
   * tag.<nombre original>, incluidas las que llevan barra como enchantable/armor.
   *
   * Dicen qué *es* la etiqueta, nunca qué objetos contiene: el selector genera
   * la lista de miembros con los nombres oficiales, así que repetirla aquí
   * duplicaría el texto y quedaría desfasada con cada versión.
   *
   * Las etiquetas con el mismo contenido solo se distinguen por este texto:
   * planks y wooden_tool_materials contienen los mismos 12 tablones.
   */
  "tag.acacia_logs": "Madera de acacia",
  "tag.anvil": "Yunques",
  "tag.armadillo_food": "Comida de armadillo",
  "tag.arrows": "Flechas",
  "tag.axes": "Hachas",
  "tag.axolotl_food": "Comida de ajolote",
  "tag.bamboo_blocks": "Bloques de bambú",
  "tag.banners": "Estandartes",
  "tag.bars": "Barrotes",
  "tag.beacon_payment_items": "Pago del faro",
  "tag.beds": "Camas",
  "tag.bee_food": "Comida de abeja",
  "tag.birch_logs": "Madera de abedul",
  "tag.boats": "Barcas",
  "tag.book_cloning_target": "Libros copiables",
  "tag.bookshelf_books": "Libros de estantería",
  "tag.breaks_decorated_pots": "Agrieta vasijas",
  "tag.brewing_fuel": "Combustible del alambique",
  "tag.bundles": "Sacos",
  "tag.buttons": "Botones",
  "tag.camel_food": "Comida de camello",
  "tag.camel_husk_food": "Comida de camello disecado",
  "tag.candles": "Velas",
  "tag.cat_collar_dyes": "Tintes de collar de gato",
  "tag.cat_food": "Comida de gato",
  "tag.cauldron_can_remove_dye": "El caldero lo destiñe",
  "tag.chains": "Cadenas",
  "tag.cherry_logs": "Madera de cerezo",
  "tag.chest_armor": "Petos",
  "tag.chest_boats": "Barcas con cofre",
  "tag.chicken_food": "Comida de pollo",
  "tag.cluster_max_harvestables": "Amatista completa",
  "tag.coal_ores": "Menas de carbón",
  "tag.coals": "Carbón y carbón vegetal",
  "tag.compasses": "Brújulas",
  "tag.completes_find_tree_tutorial": "Tutorial del árbol",
  "tag.concrete": "Hormigón",
  "tag.concrete_powders": "Cemento",
  "tag.copper": "Bloques de cobre",
  "tag.copper_chests": "Cofres de cobre",
  "tag.copper_golem_statues": "Estatuas de gólem",
  "tag.copper_ores": "Menas de cobre",
  "tag.copper_tool_materials": "Material de cobre",
  "tag.cow_food": "Comida de vaca",
  "tag.creeper_drop_music_discs": "Discos de creeper",
  "tag.creeper_igniters": "Enciende creepers",
  "tag.crimson_stems": "Tallos carmesí",
  "tag.dampens_vibrations": "Amortigua vibraciones",
  "tag.dark_oak_logs": "Madera de roble oscuro",
  "tag.decorated_pot_ingredients": "Partes de vasija",
  "tag.decorated_pot_sherds": "Fragmentos de cerámica",
  "tag.diamond_ores": "Menas de diamante",
  "tag.diamond_tool_materials": "Material de diamante",
  "tag.dirt": "Bloques de tierra",
  "tag.doors": "Puertas",
  "tag.drowned_preferred_weapons": "Armas de ahogado",
  "tag.duplicates_allays": "Duplica allays",
  "tag.dyes": "Tintes",
  "tag.eggs": "Huevos",
  "tag.emerald_ores": "Menas de esmeralda",
  "tag.enchantable/armor": "Armaduras encantables",
  "tag.enchantable/bow": "Arcos encantables",
  "tag.enchantable/chest_armor": "Petos encantables",
  "tag.enchantable/crossbow": "Ballestas encantables",
  "tag.enchantable/durability": "Encantable: durabilidad",
  "tag.enchantable/equippable": "Equipo encantable",
  "tag.enchantable/fire_aspect": "Encantable: Aspecto ígneo",
  "tag.enchantable/fishing": "Cañas encantables",
  "tag.enchantable/foot_armor": "Botas encantables",
  "tag.enchantable/head_armor": "Cascos encantables",
  "tag.enchantable/leg_armor": "Grebas encantables",
  "tag.enchantable/lunge": "Encantable: Estocada",
  "tag.enchantable/mace": "Mazas encantables",
  "tag.enchantable/melee_weapon": "Encantable: cuerpo a cuerpo",
  "tag.enchantable/mining": "Encantable: minería",
  "tag.enchantable/mining_loot": "Encantable: botín minero",
  "tag.enchantable/sharp_weapon": "Encantable: Filo",
  "tag.enchantable/sweeping": "Encantable: Barrido",
  "tag.enchantable/trident": "Tridentes encantables",
  "tag.enchantable/vanishing": "Encantable: Desaparición",
  "tag.enchantable/weapon": "Encantable: arma",
  "tag.fence_gates": "Puertas de valla",
  "tag.fences": "Vallas",
  "tag.fishes": "Pescado",
  "tag.flowers": "Flores",
  "tag.foot_armor": "Botas",
  "tag.fox_food": "Comida de zorro",
  "tag.freeze_immune_wearables": "Evita la congelación",
  "tag.frog_food": "Comida de rana",
  "tag.furnace_minecart_fuel": "Combustible de vagoneta",
  "tag.gaze_disguise_equipment": "Oculta tu mirada",
  "tag.glazed_terracotta": "Azulejos",
  "tag.goat_food": "Comida de cabra",
  "tag.gold_ores": "Menas de oro",
  "tag.gold_tool_materials": "Material de oro",
  "tag.grass_blocks": "Bloques de césped",
  "tag.hanging_signs": "Carteles colgantes",
  "tag.happy_ghast_food": "Comida de ghast feliz",
  "tag.happy_ghast_tempt_items": "Cebo de ghast feliz",
  "tag.harnesses": "Arneses",
  "tag.head_armor": "Cascos",
  "tag.hoes": "Azadas",
  "tag.hoglin_food": "Comida de hoglin",
  "tag.horse_food": "Comida de caballo",
  "tag.horse_tempt_items": "Cebo de caballo",
  "tag.ignored_by_piglin_babies": "Piglins bebés lo ignoran",
  "tag.iron_ores": "Menas de hierro",
  "tag.iron_tool_materials": "Material de hierro",
  "tag.jungle_logs": "Madera de jungla",
  "tag.lanterns": "Faroles",
  "tag.lapis_ores": "Menas de lapislázuli",
  "tag.leaves": "Hojas",
  "tag.lectern_books": "Libros de atril",
  "tag.leg_armor": "Grebas",
  "tag.lightning_rods": "Pararrayos",
  "tag.llama_food": "Comida de llama",
  "tag.llama_tempt_items": "Cebo de llama",
  "tag.logs": "Troncos y leños",
  "tag.logs_that_burn": "Troncos inflamables",
  "tag.loom_dyes": "Tintes de telar",
  "tag.loom_patterns": "Diseños de telar",
  "tag.mangrove_logs": "Madera de mangle",
  "tag.map_invisibility_equipment": "Oculta tu marca",
  "tag.meat": "Carne",
  "tag.metal_nuggets": "Pepitas de metal",
  "tag.moss_blocks": "Bloques de musgo",
  "tag.mud": "Bloques de barro",
  "tag.nautilus_bucket_food": "Peces en cubo para nautilo",
  "tag.nautilus_food": "Comida de nautilo",
  "tag.nautilus_taming_items": "Doma nautilos",
  "tag.netherite_tool_materials": "Material de netherita",
  "tag.non_flammable_wood": "Madera no inflamable",
  "tag.noteblock_top_instruments": "Cabezas del bloque musical",
  "tag.oak_logs": "Madera de roble",
  "tag.ocelot_food": "Comida de ocelote",
  "tag.pale_oak_logs": "Madera de roble pálido",
  "tag.panda_eats_from_ground": "Pandas lo recogen",
  "tag.panda_food": "Comida de panda",
  "tag.parrot_food": "Comida de loro",
  "tag.parrot_poisonous_food": "Envenena a loros",
  "tag.pickaxes": "Picos",
  "tag.pig_food": "Comida de cerdo",
  "tag.piglin_food": "Comida de piglin",
  "tag.piglin_loved": "Adorado por piglins",
  "tag.piglin_preferred_weapons": "Armas de piglin",
  "tag.piglin_repellents": "Espanta piglins",
  "tag.piglin_safe_armor": "Piglins la toleran",
  "tag.pillager_preferred_weapons": "Armas de saqueador",
  "tag.planks": "Tablones",
  "tag.rabbit_food": "Comida de conejo",
  "tag.rails": "Raíles",
  "tag.redstone_ores": "Menas de redstone",
  "tag.repairs_chain_armor": "Repara cota de mallas",
  "tag.repairs_copper_armor": "Repara armadura de cobre",
  "tag.repairs_diamond_armor": "Repara armadura de diamante",
  "tag.repairs_gold_armor": "Repara armadura de oro",
  "tag.repairs_iron_armor": "Repara armadura de hierro",
  "tag.repairs_leather_armor": "Repara armadura de cuero",
  "tag.repairs_netherite_armor": "Repara armadura de netherita",
  "tag.repairs_turtle_helmet": "Repara caparazones",
  "tag.repairs_wolf_armor": "Repara armadura de lobo",
  "tag.sand": "Arena",
  "tag.saplings": "Brotes",
  "tag.shearable_from_copper_golem": "Se esquila del gólem",
  "tag.sheep_food": "Comida de oveja",
  "tag.shovels": "Palas",
  "tag.shulker_boxes": "Cajas de shulker",
  "tag.signs": "Carteles",
  "tag.skeleton_preferred_weapons": "Armas de esqueleto",
  "tag.skulls": "Cabezas y calaveras",
  "tag.slabs": "Losas",
  "tag.small_flowers": "Flores pequeñas",
  "tag.smelts_to_glass": "Se funde en cristal",
  "tag.sniffer_food": "Comida de sniffer",
  "tag.soul_fire_base_blocks": "Base del fuego de almas",
  "tag.spears": "Lanzas",
  "tag.spruce_logs": "Madera de abeto",
  "tag.stairs": "Escaleras",
  "tag.stone_bricks": "Ladrillos de piedra",
  "tag.stone_buttons": "Botones de piedra",
  "tag.stone_crafting_materials": "Rocas para fabricar",
  "tag.stone_tool_materials": "Material de piedra",
  "tag.strider_food": "Comida de lavagante",
  "tag.strider_tempt_items": "Cebo de lavagante",
  "tag.sulfur_cube_archetype/bouncy": "Cubo de azufre: elástico",
  "tag.sulfur_cube_archetype/explosive": "Cubo de azufre: explosivo",
  "tag.sulfur_cube_archetype/fast_flat": "Cubo de azufre: rápido plano",
  "tag.sulfur_cube_archetype/fast_sliding": "Cubo de azufre: rápido deslizante",
  "tag.sulfur_cube_archetype/high_resistance": "Cubo de azufre: muy resistente",
  "tag.sulfur_cube_archetype/hot": "Cubo de azufre: caliente",
  "tag.sulfur_cube_archetype/light": "Cubo de azufre: ligero",
  "tag.sulfur_cube_archetype/regular": "Cubo de azufre: normal",
  "tag.sulfur_cube_archetype/slow_bouncy": "Cubo de azufre: lento elástico",
  "tag.sulfur_cube_archetype/slow_flat": "Cubo de azufre: lento plano",
  "tag.sulfur_cube_archetype/slow_sliding": "Cubo de azufre: lento deslizante",
  "tag.sulfur_cube_archetype/sticky": "Cubo de azufre: pegajoso",
  "tag.sulfur_cube_food": "Comida de cubo de azufre",
  "tag.sulfur_cube_swallowable": "Cubo de azufre: lo traga",
  "tag.swords": "Espadas",
  "tag.terracotta": "Terracota",
  "tag.trapdoors": "Trampillas",
  "tag.trim_materials": "Material de adornos",
  "tag.trimmable_armor": "Acepta adornos",
  "tag.turtle_food": "Comida de tortuga",
  "tag.villager_picks_up": "Aldeanos lo recogen",
  "tag.villager_plantable_seeds": "Aldeanos lo plantan",
  "tag.walls": "Muros",
  "tag.warped_stems": "Tallos distorsionados",
  "tag.wart_blocks": "Bloques de verrugas",
  "tag.wither_skeleton_disliked_weapons": "Esqueletos Wither las evitan",
  "tag.wolf_collar_dyes": "Tintes de collar de lobo",
  "tag.wolf_food": "Comida de lobo",
  "tag.wooden_buttons": "Botones de madera",
  "tag.wooden_doors": "Puertas de madera",
  "tag.wooden_fences": "Vallas de madera",
  "tag.wooden_pressure_plates": "Placas de presión de madera",
  "tag.wooden_shelves": "Estantes de madera",
  "tag.wooden_slabs": "Losas de madera",
  "tag.wooden_stairs": "Escaleras de madera",
  "tag.wooden_tool_materials": "Material de madera",
  "tag.wooden_trapdoors": "Trampillas de madera",
  "tag.wool": "Lana",
  "tag.wool_carpets": "Alfombras",
  "tag.zombie_horse_food": "Comida de caballo zombi",
