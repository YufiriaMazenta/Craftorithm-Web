...
export const koKr: Record<MessageKey, string> = {
  ...
  "picker.tagSummaryMore": "{items} 등 총 {count}개",
  "picker.tagWiki": "위키에서 {name} 보기",
  ...
  /*
   * 재료 태그의 쉬운 이름. 키는 tag.<태그 이름 그대로>이며 enchantable/ 처럼
   * 슬래시가 들어간 것도 포함한다.
   *
   * "이 태그가 무엇인지"만 쓰고 안에 든 아이템은 나열하지 않는다 —— 구성원
   * 목록은 선택기가 공식 아이템 이름으로 자동 생성하므로, 여기에 쓰면 중복되고
   * 버전이 올라가면 낡은 정보가 된다.
   *
   * 내용이 같아도 용도가 다른 태그는 이 한 줄로 구분한다: planks 와
   * wooden_tool_materials 는 펼치면 똑같은 12 종의 판자이며, 이름만이 한쪽은
   * 건축 자재, 다른 쪽은 도구 수리 재료임을 알려 준다.
   * 용어는 공식 한국어 번역(판자, 반 블록, 압력판, 갑옷 등)을 따른다.
   */
  "tag.acacia_logs": "아카시아나무",
  "tag.anvil": "모루",
  "tag.armadillo_food": "아르마딜로 먹이",
  "tag.arrows": "화살",
  "tag.axes": "도끼",
  "tag.axolotl_food": "아홀로틀 먹이",
  "tag.bamboo_blocks": "대나무 블록",
  "tag.banners": "현수막",
  "tag.bars": "창살",
  "tag.beacon_payment_items": "신호기 지불 물품",
  "tag.beds": "침대",
  "tag.bee_food": "꿀벌 먹이",
  "tag.birch_logs": "자작나무",
  "tag.boats": "보트",
  "tag.book_cloning_target": "복제 가능한 책",
  "tag.bookshelf_books": "조각된 책장용 책",
  "tag.breaks_decorated_pots": "도자기에 금을 내는 도구",
  "tag.brewing_fuel": "양조기 연료",
  "tag.bundles": "꾸러미",
  "tag.buttons": "버튼",
  "tag.camel_food": "낙타 먹이",
  "tag.camel_husk_food": "낙타 허스크 먹이",
  "tag.candles": "초",
  "tag.cat_collar_dyes": "고양이 목줄 염료",
  "tag.cat_food": "고양이 먹이",
  "tag.cauldron_can_remove_dye": "가마솥 염색 제거 장비",
  "tag.chains": "사슬",
  "tag.cherry_logs": "벚나무",
  "tag.chest_armor": "흉갑",
  "tag.chest_boats": "상자 보트",
  "tag.chicken_food": "닭 먹이",
  "tag.cluster_max_harvestables": "자수정 전량 수확",
  "tag.coal_ores": "석탄 광석",
  "tag.coals": "석탄과 숯",
  "tag.compasses": "나침반",
  "tag.completes_find_tree_tutorial": "나무 찾기 안내 원목",
  "tag.concrete": "콘크리트",
  "tag.concrete_powders": "콘크리트 가루",
  "tag.copper": "구리 블록",
  "tag.copper_chests": "구리 상자",
  "tag.copper_golem_statues": "구리 골렘 동상",
  "tag.copper_ores": "구리 광석",
  "tag.copper_tool_materials": "구리 도구 재료",
  "tag.cow_food": "소 먹이",
  "tag.creeper_drop_music_discs": "크리퍼 음반",
  "tag.creeper_igniters": "크리퍼 점화",
  "tag.crimson_stems": "진홍빛 자루",
  "tag.dampens_vibrations": "진동을 줄이는 블록",
  "tag.dark_oak_logs": "짙은 참나무",
  "tag.decorated_pot_ingredients": "장식된 도자기 재료",
  "tag.decorated_pot_sherds": "도자기 조각",
  "tag.diamond_ores": "다이아몬드 광석",
  "tag.diamond_tool_materials": "다이아몬드 도구 재료",
  "tag.dirt": "흙 계열 블록",
  "tag.doors": "문",
  "tag.drowned_preferred_weapons": "드라운드 선호 무기",
  "tag.duplicates_allays": "알레이 복제",
  "tag.dyes": "염료",
  "tag.eggs": "달걀",
  "tag.emerald_ores": "에메랄드 광석",
  "tag.enchantable/armor": "마법 부여 갑옷",
  "tag.enchantable/bow": "마법 부여 활",
  "tag.enchantable/chest_armor": "마법 부여 흉갑",
  "tag.enchantable/crossbow": "마법 부여 쇠뇌",
  "tag.enchantable/durability": "내구성 부여",
  "tag.enchantable/equippable": "마법 부여 장비",
  "tag.enchantable/fire_aspect": "발화 부여",
  "tag.enchantable/fishing": "마법 부여 낚싯대",
  "tag.enchantable/foot_armor": "마법 부여 부츠",
  "tag.enchantable/head_armor": "마법 부여 투구",
  "tag.enchantable/leg_armor": "마법 부여 레깅스",
  "tag.enchantable/lunge": "돌진 부여",
  "tag.enchantable/mace": "마법 부여 철퇴",
  "tag.enchantable/melee_weapon": "근접 무기 부여",
  "tag.enchantable/mining": "채굴 부여",
  "tag.enchantable/mining_loot": "채굴 전리품 부여",
  "tag.enchantable/sharp_weapon": "날카로움 부여",
  "tag.enchantable/sweeping": "휩쓸기 부여",
  "tag.enchantable/trident": "마법 부여 삼지창",
  "tag.enchantable/vanishing": "소실 저주 부여",
  "tag.enchantable/weapon": "무기 마법 부여",
  "tag.fence_gates": "울타리 문",
  "tag.fences": "울타리",
  "tag.fishes": "생선 음식",
  "tag.flowers": "꽃",
  "tag.foot_armor": "부츠",
  "tag.fox_food": "여우 먹이",
  "tag.freeze_immune_wearables": "동상을 막는 장비",
  "tag.frog_food": "개구리 먹이",
  "tag.furnace_minecart_fuel": "화로 수레 연료",
  "tag.gaze_disguise_equipment": "시선을 감추는 장비",
  "tag.glazed_terracotta": "유광 테라코타",
  "tag.goat_food": "염소 먹이",
  "tag.gold_ores": "금 광석",
  "tag.gold_tool_materials": "금 도구 재료",
  "tag.grass_blocks": "잔디 블록 계열",
  "tag.hanging_signs": "매다는 표지판",
  "tag.happy_ghast_food": "행복한 가스트 먹이",
  "tag.happy_ghast_tempt_items": "행복한 가스트 유인",
  "tag.harnesses": "하네스",
  "tag.head_armor": "투구",
  "tag.hoes": "괭이",
  "tag.hoglin_food": "호글린 먹이",
  "tag.horse_food": "말 먹이",
  "tag.horse_tempt_items": "말 유인",
  "tag.ignored_by_piglin_babies": "새끼 피글린이 줍지 않음",
  "tag.iron_ores": "철 광석",
  "tag.iron_tool_materials": "철 도구 재료",
  "tag.jungle_logs": "정글나무",
  "tag.lanterns": "랜턴",
  "tag.lapis_ores": "청금석 광석",
  "tag.leaves": "잎",
  "tag.lectern_books": "독서대용 책",
  "tag.leg_armor": "레깅스",
  "tag.lightning_rods": "피뢰침",
  "tag.llama_food": "라마 먹이",
  "tag.llama_tempt_items": "라마 유인",
  "tag.logs": "원목과 나무",
  "tag.logs_that_burn": "불에 타는 원목",
  "tag.loom_dyes": "베틀 염료",
  "tag.loom_patterns": "베틀 무늬",
  "tag.mangrove_logs": "맹그로브나무",
  "tag.map_invisibility_equipment": "지도 표식을 숨기는 장비",
  "tag.meat": "고기",
  "tag.metal_nuggets": "금속 조각",
  "tag.moss_blocks": "이끼 블록 계열",
  "tag.mud": "진흙 계열 블록",
  "tag.nautilus_bucket_food": "앵무조개 물고기 양동이",
  "tag.nautilus_food": "앵무조개 먹이",
  "tag.nautilus_taming_items": "앵무조개 길들이기",
  "tag.netherite_tool_materials": "네더라이트 도구 재료",
  "tag.non_flammable_wood": "불에 타지 않는 목재",
  "tag.noteblock_top_instruments": "소리 블록용 머리",
  "tag.oak_logs": "참나무",
  "tag.ocelot_food": "오실롯 먹이",
  "tag.pale_oak_logs": "창백한 참나무",
  "tag.panda_eats_from_ground": "판다가 바닥에서 줍는 먹이",
  "tag.panda_food": "판다 먹이",
  "tag.parrot_food": "앵무새 먹이",
  "tag.parrot_poisonous_food": "앵무새 중독 먹이",
  "tag.pickaxes": "곡괭이",
  "tag.pig_food": "돼지 먹이",
  "tag.piglin_food": "피글린 먹이",
  "tag.piglin_loved": "피글린이 좋아하는 금 물건",
  "tag.piglin_preferred_weapons": "피글린 선호 무기",
  "tag.piglin_repellents": "피글린 퇴치 물건",
  "tag.piglin_safe_armor": "피글린 안전 금 갑옷",
  "tag.pillager_preferred_weapons": "약탈자 선호 무기",
  "tag.planks": "판자",
  "tag.rabbit_food": "토끼 먹이",
  "tag.rails": "레일",
  "tag.redstone_ores": "레드스톤 광석",
  "tag.repairs_chain_armor": "사슬 갑옷 수리",
  "tag.repairs_copper_armor": "구리 갑옷 수리",
  "tag.repairs_diamond_armor": "다이아몬드 갑옷 수리",
  "tag.repairs_gold_armor": "금 갑옷 수리",
  "tag.repairs_iron_armor": "철 갑옷 수리",
  "tag.repairs_leather_armor": "가죽 갑옷 수리",
  "tag.repairs_netherite_armor": "네더라이트 갑옷 수리",
  "tag.repairs_turtle_helmet": "거북 등딱지 수리",
  "tag.repairs_wolf_armor": "늑대 갑옷 수리",
  "tag.sand": "모래",
  "tag.saplings": "묘목",
  "tag.shearable_from_copper_golem": "구리 골렘에서 깎아냄",
  "tag.sheep_food": "양 먹이",
  "tag.shovels": "삽",
  "tag.shulker_boxes": "셜커 상자",
  "tag.signs": "표지판",
  "tag.skeleton_preferred_weapons": "스켈레톤 선호 무기",
  "tag.skulls": "머리와 해골",
  "tag.slabs": "반 블록",
  "tag.small_flowers": "작은 꽃",
  "tag.smelts_to_glass": "유리로 제련",
  "tag.sniffer_food": "스니퍼 먹이",
  "tag.soul_fire_base_blocks": "영혼 불 받침 블록",
  "tag.spears": "창",
  "tag.spruce_logs": "가문비나무",
  "tag.stairs": "계단",
  "tag.stone_bricks": "석재 벽돌",
  "tag.stone_buttons": "돌 버튼",
  "tag.stone_crafting_materials": "조약돌 계열 조합 재료",
  "tag.stone_tool_materials": "돌 도구 재료",
  "tag.strider_food": "스트라이더 먹이",
  "tag.strider_tempt_items": "스트라이더 유인",
  "tag.sulfur_cube_archetype/bouncy": "유황 큐브: 탄력",
  "tag.sulfur_cube_archetype/explosive": "유황 큐브: 폭발",
  "tag.sulfur_cube_archetype/fast_flat": "유황 큐브: 고속 평면",
  "tag.sulfur_cube_archetype/fast_sliding": "유황 큐브: 고속 활주",
  "tag.sulfur_cube_archetype/high_resistance": "유황 큐브: 고저항",
  "tag.sulfur_cube_archetype/hot": "유황 큐브: 고온",
  "tag.sulfur_cube_archetype/light": "유황 큐브: 경량",
  "tag.sulfur_cube_archetype/regular": "유황 큐브: 일반",
  "tag.sulfur_cube_archetype/slow_bouncy": "유황 큐브: 저속 탄력",
  "tag.sulfur_cube_archetype/slow_flat": "유황 큐브: 저속 평면",
  "tag.sulfur_cube_archetype/slow_sliding": "유황 큐브: 저속 활주",
  "tag.sulfur_cube_archetype/sticky": "유황 큐브: 점착",
  "tag.sulfur_cube_food": "작은 유황 큐브 먹이",
  "tag.sulfur_cube_swallowable": "유황 큐브가 삼킴",
  "tag.swords": "검",
  "tag.terracotta": "테라코타",
  "tag.trapdoors": "다락문",
  "tag.trim_materials": "갑옷 장식 재료",
  "tag.trimmable_armor": "장식 가능한 갑옷",
  "tag.turtle_food": "거북 먹이",
  "tag.villager_picks_up": "주민이 줍는 아이템",
  "tag.villager_plantable_seeds": "주민이 심는 씨앗",
  "tag.walls": "담장",
  "tag.warped_stems": "뒤틀린 자루",
  "tag.wart_blocks": "사마귀 블록",
  "tag.wither_skeleton_disliked_weapons": "위더 스켈레톤이 싫어함",
  "tag.wolf_collar_dyes": "늑대 목줄 염료",
  "tag.wolf_food": "늑대 먹이",
  "tag.wooden_buttons": "나무 버튼",
  "tag.wooden_doors": "나무 문",
  "tag.wooden_fences": "나무 울타리",
  "tag.wooden_pressure_plates": "나무 압력판",
  "tag.wooden_shelves": "나무 선반",
  "tag.wooden_slabs": "나무 반 블록",
  "tag.wooden_stairs": "나무 계단",
  "tag.wooden_tool_materials": "나무 도구 재료",
  "tag.wooden_trapdoors": "나무 다락문",
  "tag.wool": "양털",
  "tag.wool_carpets": "양탄자",
  "tag.zombie_horse_food": "좀비 말 먹이",
